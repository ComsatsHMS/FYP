                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" > View Complains </div>
                               <div class="panel-body">
                                ...
                                ?>
                                <textarea style="height:150px" readonly name="ComplainText" class="col-md-offset-1 col-md-8 col-md-offset-3 col-xs-4" id="complain_box"><?php $text = $_GET['text'];echo "$text" ?></textarea>
                             </div>
                        </div>
                    </div>
                </div>
