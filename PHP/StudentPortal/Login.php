...
<div class="login-card">
    ...
    <form class="form-signin form-inline" action="LoginProcessing.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input name="rollNumber" class="form-control" type="text" required></div>
    ...
    <p>Are you new student?<a href="NewStudentLogin.php">Login Here</a></p>
</div>
<footer>
    <div class="row">
