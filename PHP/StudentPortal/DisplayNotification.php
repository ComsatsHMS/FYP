    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="../ParentPortal/Notifications.php"><i class="fa fa-"></i> Notifications</a>
                </li>
                    ...
                    <div class="board">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                $query=mysqli_query($connection,"update notification set view=1 where number=$check");
                                ?>
                                <textarea style="height:150px" readonly name="NotificationText" class="col-md-offset-1 col-md-8 col-md-offset-3 col-xs-4" id="notification_box"><?php echo file_get_contents("../mydocs/"."$file "); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
