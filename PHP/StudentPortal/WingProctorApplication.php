            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="WingProctorApplication.php">Wing Proctor</a>
                        </li>
                    </ul>
                </li>
                <?php
    ...
    <div id="page-wrapper">
        <div class="header row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Wing Proctor Application</li>
            </ol>
        </div>
        <div id="page-inner">
            <div class="row">
                    ...
                    <div class="board">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                <form role="form" action="WingProctorApplication.php" method="post"
                                    ...
                                    <div class="form-group ">
                                        <button id="button" style="float: right" type='submit' name="wingProctor"
