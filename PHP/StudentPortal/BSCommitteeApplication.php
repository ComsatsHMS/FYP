...
if(isset($_POST['submit'])){
    $s_id = $_SESSION['id'];
    $application_type = "Blood Society";
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="BSCommitteeApplication.php">Blood Society Committee</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper">
        <div class="header row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Blood Society Committe Application</li>
            </ol>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-primary">
                            <div class="panel-heading" > Blood Society Committe Application </div>
                                <div class="panel-body">
                                    ...
                                    ?>
                                   <form role="form" action="BSCommitteeApplication.php" method="post" enctype="multipart/form-data">
                                     <div class="form-group ">
                                        <label for="text">Application content</label>
                                        <textarea class="form-control" name="text" rows="9" cols="20" required></textarea>
                                    </div>
                                         <div class="form-group ">
                                          <button id="button" style="float: right" type='submit' name="submit" class="btn btn-success">submit</button>
                                         </div>
                                </form>
                            </div>
