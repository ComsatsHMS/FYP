...
if(isset($_POST['submit'])){
    ...
    $s_id = $_SESSION['id'];
    $application_type = "Sports Committee";
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="SportsCommitteeApplication.php">Sports Comitee</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper">
        <div class="header row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Sports Committe Application</li>
            </ol>
        </div>
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-primary">
                            <div class="panel-heading" > Sports Comitte Application </div>
                                 <div class="panel-body">
                                     ...
                                     ?>
                                    <form role="form" action="SportsCommitteeApplication.php" method="post" enctype="multipart/form-data">
