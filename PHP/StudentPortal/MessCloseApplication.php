                            ...
                            <div class="panel-heading" > Mess Close Application </div>
                              <div class="panel-body">
                                ...
                                <form role="form" action="MessCloseApplication.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        <label class="control-label col-md-2 col-xs-6 col-sm-6" for="lastdate">To</label>
                                    ...
                                    <div class="form-group ">
                                        <button id="button" style="float: right" type='submit' name="messclose" class="btn btn-success">submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
