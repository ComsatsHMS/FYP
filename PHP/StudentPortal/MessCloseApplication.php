            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="active-menu" href="MessCloseApplication.php">Mess Close</a>
                        </li>
                        <li>
                    ...
                    <div class="board">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                <form role="form" action="MessCloseApplication.php" method="post"
                                      enctype="multipart/form-data">
                                    <div class="form-group ">
                                        <label class="control-label col-md-2 col-xs-6 col-sm-6" for="startdate">Close
                                            from</label>
                                        <input type="date" name="startdate" required>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-md-2 col-xs-6 col-sm-6"
                                               for="lastdate">To</label>
                                    ...
                                    <div class="form-group ">
                                        <button id="button" style="float: right" type='submit' name="messclose"
