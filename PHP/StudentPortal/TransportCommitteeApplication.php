                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-primary">
                            <div class="panel-heading" > Transport Committee Application </div>
                                <div class="panel-body">
                                    ...
                                    ?>
                                     <form role="form" action="TransportCommitteeApplication.php" method="post" enctype="multipart/form-data">
