...
?>
    ...
    <h2 style="text-align: center">Web Admin Login</h2>
    <hr width="370px">
...
<!--            <p class="forgot"><a href="javascript:showhide('pwreset','signin','forget')">Forgot Password?</a></p>-->
        ...
        <form id="pwreset" method="post" action="../ParentPortal/LoginProcessing.php" enctype="multipart/form-data" style="display: none">
