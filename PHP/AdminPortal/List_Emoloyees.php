    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="List_Emoloyees.php"><i class="fa fa-"></i> Employee's List</a>
                </li>
                <li>
        ...
        <div id="page-inner">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #999999"> List Of Emplotees </div>
            ...
            <td> $phone </td>
             <td>  <a href='Admin_processing.php?id=$id'><span class=\"glyphicon glyphicon-trash\"></span></a>
              <a href='Rights.php?id3=$id&amp;name=$first'>
