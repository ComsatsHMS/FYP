        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                if($_SESSION['StudentsList'] == 1){
                    echo " <li >
                    <a class=\"active-menu\" href=\"#\"><i class=\"fa fa-\"></i> Student's List<span class=\"fa arrow\"></span></a>
                    <ul class=\"nav nav-second-level\">
                        <li>
                            <a  href=\"SelectedStudents.php\">Selected</a>
                        </li>
                        <li>
                            <a class=\"active-menu\" href=\"NotSelectedStudents.php\">Not Selected</a>
                        </li>
                    </ul>
                </li>";
                }
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #999999"> Not Selected for Hostel Student's List </div>
