                    ...
                    <div class="board">
                        <div class="panel panel-primary">
                            <div class="panel-heading nav navbar-inverse" style="max-height: 70px;">
                                <div class="col-md-5">
                                    <h3 class="panel-title" style="padding-top: 15px">Used Items History</h3>
                                </div>
                                <div class="col-md-7">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown active"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">History <span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <form method="post" action="#Search">
                                            ...
                                            <input type="date" name="StartDate" id="StartDate" style="max-width: 130px">
                                            <label for="Balance">To </label>
                                            <input type="date" name="EndDate" id="EndDate" style="max-width: 130px">
                                            <br>
                                        ...
                                        <form method="post" action="#Search">
                                            ...
                                            <input type="submit" name="SearchByItemNo" id="search" value="Search">
                                        </form>
