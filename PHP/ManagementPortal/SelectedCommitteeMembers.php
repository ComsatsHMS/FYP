        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                if ($_SESSION['Applications'] == 1) {
                    echo "<li>
                    <a href=\"ViewStudentApps.php\" class=\"active-menu\"><i class=\"fa fa-\"></i> View Applications</a>
                </li>";
                }
                if ($_SESSION['Fine'] == 1) {
                    echo "<li>
                    ...
                    <div class="board">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                    <a href="ViewStudentApps.php">
                                        <button class="btn-primary"> View Applications</button>
                                    </a>
                                </div>
