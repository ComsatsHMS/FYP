...
global $connection;
    if(isset($_SESSION['comptype'])) {
        ...
        while ($each_record = mysqli_fetch_array($run)){
            ...
            <td> $Complain_Date </td>
            <td> $Hostel </td>
            <td> <button type='button'  id='view' class='btn btn-success'><a href='ComplainsDisplay.php?id=$Complain_ID & room=$Room_No & name=$Student_Name & text=$Complain_Text'>$status_</a> </button> </td>
            <td> $ViewBy </td>
            </tr>
        ";
        }
