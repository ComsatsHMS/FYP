                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #999999"> Purchased History </div>
                            <div class="panel-body">
                                <div class="col-md-3">
                                    <div class="btn-group btn-group-sm btn-group-vertical" style="padding-top: 40pt">
                                        ...
                                        <a href="PurchasedHistory.php" class="btn btn-default active-menu" style="background-color: #999999;color: white">Purchased History</a>
