                        ...
                        <div class="board">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" name="studentForm" method="post" action="Profile_Processing.php"  >
                                        <?php
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2 col-xs-2" for="fname">First Name:</label>
                                            <div class="col-md-4 col-xs-4">
                                                <input type="text" class="form-control" value="<?PHP echo "{$_SESSION['fname']}";?>" <?php if($_SESSION['fname']!='') echo"readonly"; ?> id="name" name="fName" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2 col-xs-2" for="lname">Last Name:</label>
                                            <div class="col-md-4 col-xs-4">
                                                <input type="text" class="form-control" id="father_name"  value="<?PHP echo "{$_SESSION['lname']}";?>" <?php if($_SESSION['lname']!='') echo"readonly"; ?> name="lName">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                <input type="text" class="form-control"  value="<?PHP echo "{$_SESSION['hostel']}";?>" <?php if($_SESSION['hostel']!='') echo"readonly"; ?> id="hostel" name="hostel">
                                            </div>
                                        </div>
                                        <div class="form-group">
