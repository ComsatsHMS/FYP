                    ...
                    <div class="board">
                        <div class="panel panel-primary">
                            <div class="panel-heading nav navbar-inverse" style="max-height: 70px;">
                                <div class="col-md-5">
                                    <h3 class="panel-title" style="padding-top: 15px">Payable History</h3>
                                </div>
                                <div class="col-md-7">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <div class="btn-group btn-group-md col-md-offset-4">
                                        <a href="javascript:showhide('Payable','PaidHistory','btn')"
                                           class="btn btn-default" id="view" >View
                                            Payable</a>
                                        <a href="javascript:showhide('Payable','PaidHistory','btn1')"
                                           class="btn btn-default" id="view">Paid
                                            History</a>
                                    </div>
                                    ...
                                    <div id="PaidHistory" style="display: none">
                                        <div class="form-group ">
                                            ...
                                            <form method="post" action="#Search">
                                                ...
                                                <input type="submit" name="SearchByRefrenceNo" id="search" value="Search">
                                            </form>
                                    ...
                                    <div id="Payable" style="display: none">
                                        <div class="form-group ">
                                            ...
                                            <form method="post" action="#Search">
                                                <label for="Balance">Serach By Refrence No: </label>
                                                <input type="text" name="SearchRefrenceNo">
                                                <input type="submit" name="SearchByRefrenceNo1" id="search" value="Search">
                                            </form>
