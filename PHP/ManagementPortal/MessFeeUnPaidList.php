            ...
            <ul class="nav" id="main-menu">
                ...
                if($_SESSION['Fine'] == 1){
                    ...
                    <ul class=\"nav nav-second-level\">
                        ...
                        <li>
                            <a href=\"MessFeeUnPaidList.php\" class=\"active-menu\">Mess Fee unPaid Student's List</a>
                        </li>
                    </ul>
                </li>";
                }
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="board">
                        <div class="panel panel-primary">
                            <div class="panel-heading" > Mess Fee UnPaid Student's List </div>
                            <div class="panel-body">
                                ...
                                <script>
                                    $("#hostel").on("change", function(){
                                        ...
                                        window.location = "MessFeeUnPaidList.php?selected="+selected;
                                    })
                                </script>
                                <table class="table">
                                    <tr>
                                    ...
                                    if(isset($_POST['search'])){
                                        ...
                                        studentSearchByNameUnFeePaid($temp);
                                    }elseif(isset($_GET['selected'])){
                                        $temp1 = $_GET['selected'];
                                        studentSearchByHostelUnFeePaid($temp1);
                                    }
                                    else{
                                        getFeeUnPaidStudentsList();
                                    }
                                    ?>
