...
<html lang="en">
<head>
    <title>Higher Management Login</title>
    <meta charset="utf-8">
...
<div class="row">
    <ul class="nav nav-tabs navbar-inverse">
        <li class="col-md-6 active"><a data-toggle="tab" href="#login1"><strong>Hostel Warden Login</strong></a></li>
    </ul>
</div>
    ...
    <div id="login1" class="tab-pane fade in active">
        <div class="background1 row" >
            ...
            <div  class="comsats col-md-12 col-xs-12">
                ...
                <br>
                <div>
                    <a href="WardenPortal.php"><input type="submit" value="login" name="submit"> </a>
                </div>
